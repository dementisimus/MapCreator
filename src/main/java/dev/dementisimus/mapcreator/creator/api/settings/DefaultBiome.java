...
import static dev.dementisimus.mapcreator.creator.api.settings.DefaultWorldEnvironment.OVERWORLD;
/**
...
public enum DefaultBiome {
    ...
    @Getter private final DefaultWorldEnvironment worldEnvironment;
    @Getter private final Biome biome;
    @Getter private final String translationProperty;
    @Getter private final Material icon;

    DefaultBiome(DefaultWorldEnvironment worldEnvironment, Biome biome, String translationProperty, Material icon) {
